...
<div class="resultContainer">
 <div class="banner " align ="center">
	<img src="${contextPath}/resources/image/order.png" class="img-fluid" alt="review">
	</div>
<form name="form_result">

 <p class="fs-3 mt-5"><i class="bi bi-gift"></i>&nbsp;주문내역</p>
...
<DIV class="clear"></DIV>
<p class="fs-3 mb-1 mt-5"><i class="bi bi-gift"></i>&nbsp;배송정보</p>
...
<p class="fs-3 mb-1  mt-5"><i class="bi bi-gift"></i>&nbsp;주문고객</p>
<div class="detail_table">
  <table  class="table table-hover">
		<thead>
			<tr>
...
<p class="fs-3 mb-1  mt-5"><i class="bi bi-gift"></i>&nbsp;결제정보</p>
 <div class="detail_table">
  <table  class="table table-hover">
   <thead>
		<tr>
